...
if (TYPO3_MODE === 'BE') {
	...
	\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
		...
		'',						// Position
		array(
			'Event' => 'list, show, new, create, edit, update, delete','EventLocation' => 'list, show, new, create, edit, update, delete','EventCategory' => 'list, show, new, create, edit, update, delete',
		),
		array(
			'access' => 'user,group',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile($_EXTKEY, 'Configuration/TypoScript', 'typo3EventManager');
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addLLrefForTCAdescr('tx_otevents_domain_model_eventlocation', 'EXT:ot_events/Resources/Private/Language/locallang_csh_tx_otevents_domain_model_eventlocation.xlf');
